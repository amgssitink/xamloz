...
local Main = Library.CreateMain({Title = 'Gay', Desc = ''})

local Page1 = Main:CreatePage("Page 1")
local Page2 = Main:CreatePage("Page 2")

local Section1 = Page1:CreateSection("Section Name")
local Section2 = Page2:CreateSection("Name")
