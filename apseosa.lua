...
local Tabs = {
    Shop = Window:AddTab({ Title = "Shop", Icon = "rbxassetid://4483345998" }),    
    Main = Window:AddTab({ Title = "Main", Icon = "rbxassetid://4483345998" }),
    Setting = Window:AddTab({ Title = "Setting", Icon = "rbxassetid://4483345998" }),
    Stats = Window:AddTab({ Title = "Stats", Icon = "rbxassetid://4483345998 }),
    Player = Window:AddTab({ Title = "Player", Icon = "rbxassetid://4483345998" }),
    Teleport = Window:AddTab({ Title = "Island", Icon = "rbxassetid://4483345998" }),
    Fruit = Window:AddTab({ Title = "Fruit", Icon = "rbxassetid://4483345998" }),
    Raid = Window:AddTab({ Title = "Raid", Icon = "rbxassetid://4483345998" }),
    Race = Window:AddTab({ Title = "Race V4", Icon = "rbxassetid://4483345998" }), 
	Misc = Window:AddTab({ Title = "Misc", Icon = "rbxassetid://4483345998" }),
    Hop = Window:AddTab({ Title = "Hop", Icon = "rbxassetid://4483345998" }),
}
...
local ToggleKillTrail = Tabs.Race:AddToggle("ToggleKillTrail", {Title = "Auto Kill Trail", Default = false })
ToggleKillTrail:OnChanged(function(Value)
  _G.AutoKillTial = Value
  StopTween(_G.AutoKillTial)
end)
Options.ToggleKillTrail:SetValue(false)
spawn(function()
        while wait() do
